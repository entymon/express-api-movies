...
const movies = [
  ...
  { title: 'Shogun', year: 1980, runtime: 60, genres: ['Adventure', 'Drama', 'History'], director: 'N/A', actors: 'Richard Chamberlain, Toshirô Mifune, Yôko Shimada, Furankî Sakai', plot: 'A English navigator becomes both a player and pawn in the complex political games in feudal Japan.', posterUrl: 'https://images-na.ssl-images-amazon.com/images/M/MV5BMTY1ODI4NzYxMl5BMl5BanBnXkFtZTcwNDA4MzUxMQ@@._V1_SX300.jpg' },
